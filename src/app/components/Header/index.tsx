    ...
    <div className='header'>
      <div className="header-nav">
        <ul className="header-nav-links">
          <li className="header-link-item"><Link to="/" className="header-link-item-href transition-colors">Главная</Link></li>
          <li className="header-link-item"><Link to="/habits" className="header-link-item-href transition-colors">Привычки</Link></li>
          <li className="header-link-item"><Link to="/h" className="header-link-item-href transition-colors">Задачи</Link></li>
